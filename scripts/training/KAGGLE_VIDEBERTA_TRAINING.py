"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  🔥 SafeSense-VI: ViDeBERTa Toxic Comment Classification                     ║
║  Complete Training Notebook for KAGGLE                                       ║
║                                                                               ║
║  📌 MODEL: Fsoft-AIC/videberta-base (86M params)                             ║
║  📌 DATA: final_train_data_v3_SEMANTIC.xlsx (RAW TEXT + SEMANTIC TOKENS)     ║
║  📌 MAX LENGTH: 512 tokens (vs PhoBERT 256)                                  ║
...
║  3. Add dataset: Upload file final_train_data_v3_SEMANTIC.xlsx               ║
║  4. Internet: ON (để download model)                                          ║
║                                                                               ║
║  KEY DIFFERENCES vs PhoBERT:                                                  ║
║  ✅ No word segmentation (raw Vietnamese text)                               ║
║  ✅ Semantic tokens: <sep>, <emo_pos>, <person>, etc.                        ║
║  ✅ Longer context: 512 tokens                                               ║
║  ✅ Smaller model: 86M vs 135M params                                        ║
...
class Config:
    ...
    # Kaggle Paths
    DATA_PATH = "/kaggle/input/safesense-videberta-data/final_train_data_v3_SEMANTIC.xlsx"
    OUTPUT_DIR = "/kaggle/working"
    MODEL_SAVE_PATH = "/kaggle/working/videberta_toxic_model"
    
    # Special tokens for ViDeBERTa
...
# IMPORTANT: Resize embeddings for new special tokens
...
print(f"   (PhoBERT-base: 135M params)")
print(f"   (ViDeBERTa-base: 86M params - 36% smaller!)")
