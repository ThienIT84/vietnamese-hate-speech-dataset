...
# Load unlabeled data
unlabeled_df = pd.read_csv(r'c:\Học sâu\Dataset\TOXIC_COMMENT\unlabeled_with_context_phobert.csv')
...
output_path = r'c:\Học sâu\Dataset\TOXIC_COMMENT\label1_candidates_150samples.csv'
